...
1. Press <Btn btn="SELECT" /> to enable FTP access on your device
    + You may need change from USB mode to FTP mode. To change to FTP mode, first press <Btn btn="start"> and change "SELECT button" from "USB" to "FTP". For username, you can use "guest"
